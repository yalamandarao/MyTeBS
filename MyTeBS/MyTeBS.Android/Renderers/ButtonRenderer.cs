...
[assembly: ExportRenderer(typeof(Navigation.Core.Controls.Button),
                          typeof(Navigation.Droid.Renderers.ButtonRenderer))]
  ...
  public class ButtonRenderer : Xamarin.Forms.Platform.Android.ButtonRenderer
  {
    ...
    void UpdateBackgroundDrawable()
    {
          ...
          || disabledDrawable != null)
      {
        ...
        {
          var drawable = Resources.GetIdentifier(disabledDrawable, "drawable", Context.PackageName);
        ...
        {
          var drawable = Resources.GetIdentifier(pressedDrawable, "drawable", Context.PackageName);
          stateListDrawable.AddState(
            new[] { Android.Resource.Attribute.StateEnabled,
        ...
        if (drawableName != null)
        {
          var drawable = Resources.GetIdentifier(drawableName, "drawable", Context.PackageName);
          stateListDrawable.AddState(
            new[] { Android.Resource.Attribute.StateEnabled },
            ContextCompat.GetDrawable(Context, drawable));
        }
